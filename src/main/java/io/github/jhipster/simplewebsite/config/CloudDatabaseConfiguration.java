package io.github.jhipster.simplewebsite.config;
...
@Configuration
@EnableMongoRepositories("io.github.jhipster.simplewebsite.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.github.jhipster.simplewebsite.config.dbmigrations");
